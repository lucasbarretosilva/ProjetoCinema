...
namespace ProjetoCinema.Controllers
{
    public class SalaController : Controller
    {
        ...
        public SalaController(ProjetoCinemaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("SalaId,QuantidadeAssentos,Disponivel")] Sala sala)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SalaId,QuantidadeAssentos,Disponivel")] Sala sala)
        {
            if (id != sala.SalaId)
            {
                return NotFound();
